...
namespace Cookle.Data
{
    public class ApplicationDbContext : IdentityDbContext<User, IdentityRole<int>, int>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            modelBuilder.Entity<Frigorifico>().HasData(
                new Frigorifico() { UserId = 1, IngredienteId = 1, Data = DateTime.Parse("2019-06-30"), IngredienteId1 = 1, Quantidade= 3});
            #endregion

            #region HistoricoSeed
            modelBuilder.Entity<Historico>().HasData(
                new Historico() { UserId = 1, ReceitaId = 1, Numero= 1, UltimaVez = DateTime.Parse("2019-06-30"), IngredienteId1 = 1, Quantidade= 3});
            #endregion
            ...
            modelBuilder.Entity<IngredienteReceita>().HasData(
                ...
                new IngredienteReceita() { IngredienteId = 5, ReceitaId = 1, Quantidade=0.25, Unidade=1});
            ...
            modelBuilder.Entity<Nota>().HasData(
                new Nota() { Id = 1, Data = DateTime.Parse("2019-06-01"), Descricao= "Acrescentar mais açucar na próxima confeção.", ReceitaId=1, UserId=1});
            #endregion


            #region NutrienteSeed
            modelBuilder.Entity<Nutriente>().HasData(
                new Nutriente() { Id = 1, Nome="Proteína", Unidade=1});
            #endregion

            #region NutrienteReceitaSeed
            modelBuilder.Entity<NutrienteReceita>().HasData(
                new NutrienteReceita() { NutrienteId = 1, ReceitaId=1, NutrienteId1=1, Quantidade=3});
            #endregion

            #region PassoSeed
            modelBuilder.Entity<Passo>().HasData(
            ...
            modelBuilder.Entity<PlanoReceita>().HasData(
                new PlanoReceita() { UserId = 1, ReceitaId=1});
            #endregion
            
            #region PreferenciaIngredienteSeed
            modelBuilder.Entity<PreferenciaIngrediente>().HasData(
                new PreferenciaIngrediente() { UserId = 1, IngredienteId=1, Tipo=1});
            #endregion
